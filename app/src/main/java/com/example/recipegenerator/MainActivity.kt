...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.add((CurvedBottomNavigation.Model(1, "", R.drawable.baseline_menu_book_24)))
        bottomNavigationView.add((CurvedBottomNavigation.Model(2, "",R.drawable.baseline_soup_kitchen_24)))
        bottomNavigationView.add((CurvedBottomNavigation.Model(3, "", R.drawable.baseline_settings)))
